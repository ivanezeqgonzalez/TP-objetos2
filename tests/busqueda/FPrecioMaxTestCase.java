...
public class FPrecioMaxTestCase {
	...
	@Test
	public void testSiFiltroSeAplicaAunArrayDeUnaPublicacionConPrecioMayorAlDelFiltroNoMatcheaNada() {
		when(publicacionUno.getPrecio()).thenReturn((double) 100);
	...
	@Test
	public void testSiFiltroSeAplicaAunArrayDeUnaPublicacionConPrecioMenorAlDelFiltroMatchea() {
